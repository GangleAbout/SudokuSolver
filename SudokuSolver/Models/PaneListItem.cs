...
public partial class PaneListItem
{
    ...
    /// <summary>
    ///     Initialises new instance of PaneListItem class
    /// </summary>
    ...
    public PaneListItem(Type viewModelType, string label, string iconKey)
    {
    ...
    /// <param name="viewModelType">Type of *ViewModel</param>
    /// <param name="iconKey">Icon to show in ListItem</param>
    public PaneListItem(Type viewModelType, string iconKey)
    {
        ViewModelType = viewModelType;

        var viewModelName = viewModelType.Name.Replace("ViewModel", "");

        Label = PascalCaseSplitRegex().Replace(viewModelName, " $1").Trim();
    ...
    /// <summary>
    ///     Regex to split a PascalCase string into separate words
    /// </summary>
    /// <returns></returns>
